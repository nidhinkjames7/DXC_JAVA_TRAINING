...
public class CustomerBanking {
	...
	public static void main(String[] args) throws Exception {
		...
		for(Customer customer: mObject.mCustomerList) 
			System.out.println("Customer Deatials Are:"
					+ "\n Name:"+customer.getName()+
					"\nEmail:"+customer.getEmail()
							+ "\nPhone Number:"+customer.getPhone()+
							"\nBalance:"+customer.getBalanace()+
							"\nThis customer performed "+customer.getOperationCounter()+
							" operations"
							+"\nNo.of AccountOpened: "+customer.getOpenAccCounter()
							+"\nNo.of times money deposited"+customer.getDepositCounter()
							+"\nNo.of times moneyWithdrawed"+customer.getWithdrawlCounter()
							+"\nNo.of times FD opened"+customer.getOpenFDCounter());
